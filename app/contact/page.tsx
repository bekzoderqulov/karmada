  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      try {
        ...
        localStorage.setItem("helpRequests", JSON.stringify([...helpRequests, newRequest]))
      } catch (error) {
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-primary/10 to-primary/5">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-3xl md:text-5xl font-bold mb-6">{t("contactUs")}</h1>
            <p className="text-xl text-muted-foreground">{t("contactUsSubtitle")}</p>
          </div>
        </div>
      </section>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">info@itenglish.academy</p>
                  </div>
                </div>
